...
SOURCE_COOP_CSB_URL = (
    "https://data.source.coop/datasets/us-usda-cropland/"
    "us_usda_cropland.parquet"
)
...
def main():
    ...
    centroids[["field_id", "county_fips", "crop_2024", "area_acres", "centroid_lat", "centroid_lon"]].to_csv(
